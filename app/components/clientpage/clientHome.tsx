...
import Sidebar from '../../components/sidebar'; // Ajuste o caminho conforme a nova estrutura (tudo minúsculo)
            ...
            <main className="main-content">
                ...
                <section className="user-info">
                    <div className="user-profile">
                        <img src="https://via.placeholder.com/150" alt="Foto do usuário" className="user-photo" />
                        <div>
                ...
                <section className="medical-info">
                    <div className="user-details">
                        <div className="top-details">
                            <div className="user-detail">
                                <p><strong>Tipo Sanguíneo</strong></p>
                                <p>Não informado</p>
                            </div>
                            <div className="user-detail">
                            ...
                            <div className="user-detail">
                                <p><strong>Doença Crônica</strong></p>
                                <p>Não informado</p>
                            </div>
                        </div>
                    </div>
